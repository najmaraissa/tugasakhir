...
begin
  ...
  zqry1.SQL.Clear;
  zqry1.SQL.Add('Update data_prestasi set no="'+edt1.Text+'",nama_siswa="'+edt2.Text+'",nis="'+edt3.Text+'",nisn="'+edt4.Text+'",jenis_kelamin="'+edt5.Text+'",jurusan="'+edt6.Text+'",nama_wali_kelas="'+edt7.Text+'",nama_ortu="'+edt8.Text+'",telp/hp_ORTU="'+edt9.Text+'",jenis_prestasi="'+edt10.Text+'",keterangan="'+edt11.Text+'",bulan="'+edt12.Text+'",tahun_pelajaran="'+edt13.Text+'", where id ="'+id+'"');
  zqry1.ExecSQL;
...
begin
  zqry1.SQL.Clear;
  zqry1.SQL.Add('delete from data_prestasi where id ="'+id+'"');
  zqry1.ExecSQL;
  zqry1.SQL.Clear;
  zqry1.SQL.Add('select * from data_prestasi');
  zqry1.Open;
